...
Papers in journals
------
1. **Teng Li**, Amir Zakerimanesh, Yafei Ou, Armin Badre, and Mahdi Tavakoli. <font color="ForestGreen"> "Iterative Learning for Gravity Compensation in Impedance Control" </font>. <font color="RoyalBlue"> IEEE/ASME Transactions on Mechatronics</font>, pp. 1-12, **2024**. <font color="DarkGoldenRod"> _(with a 3DOF PHANToM Premium 1.5A robot)_ </font> [[IEEE Xplore](https://ieeexplore.ieee.org/document/10507161)] [[Demo Video](https://youtu.be/2BzboHYSa68)] [[ResearchGate](https://www.researchgate.net/publication/380049055_Iterative_Learning_for_Gravity_Compensation_in_Impedance_Control)]
...
<!-- <font color="green"> Some green text 02 </font> (works in HTML page but not in GitHub. DarkGoldenRod, DarkKhaki, DarkSlateBlue,ForestGreen,RoyalBlue ) -->
