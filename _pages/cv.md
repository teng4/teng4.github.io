...
Publications
------
1. **Teng Li**, Armin Badre, and Mahdi Tavakoli. "<font color="RoyalBlue">Robotic Assistance and Haptic Feedback in Arthroscopic Procedures: Design and Preliminary Evaluation of a Two-Arm System</font>". <font color="DarkGoldenRod"> Journal of Medical Robotics Research</font> <font color="Gray">(JMRR)</font>, pp. 1-15, **2024**. _(<font color="LightGray"> with two Quanser's 6DOF HD<sup>2</sup> robots </font>)_ [[JMRR]()] [[Demo Video]()] [[ResearchGate]()]..
